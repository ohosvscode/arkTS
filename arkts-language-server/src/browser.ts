import { createConnection, createServer, createTypeScriptProject } from '@volar/language-server/browser'
...
connection.onInitialize(async (params) => {
  const initializer = await createArkTSInitializer(server, arkts, params, 'browser', fileUri)
