...
async function fetchData(returnValue?: UnwrapNestedRefs<UseOffsetPaginationReturn>) {
  try {
    ...
    const response = await connection.requestTemplateMarketList?.({
...
const scrollTarget = ref<Document | null>(null)
onMounted(() => scrollTarget.value = typeof document !== 'undefined' ? document : null)
